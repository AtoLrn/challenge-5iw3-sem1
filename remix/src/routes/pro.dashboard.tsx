				...
				{ clients.map((client, index) => {
					return <div key={client} className='flex w-full p-2 cursor-pointer border-b-1 border-gray-200 border-opacity-30 gap-2'>
						...
						<div className='flex flex-col'>
							...
							<span >
								In 5 Minutes <span className='text-zinc-500'>(14h30)</span>
							</span>
						</div>
			...
			<div className='w-72  bg-zinc-950 rounded-xl shadow-2xl flex flex-col justify-center items-center gap-2 text-white p-4 border-1 border-red-900'>
				<div className='relative flex border-1 border-gray-200 border-opacity-30 rounded-3xl w-full p-1 justify-between items-center'>
					<div className='relative flex'>
						{ clients.map((client, index) => {
							return  <img key={index}  style={{zIndex: 50 - index}} className={ `rounded-full relative border-2 border-gray-900 -left-${index * 4} object-cover w-8 h-8` } src={client}/>
						}) }
					</div>
