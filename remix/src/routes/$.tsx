...
export function ErrorBoundary() {
	return <main className='min-h-screen min-w-full bg-black text-white flex flex-col justify-center items-center gap-4 relative'>
		<div className='z-20 flex flex-col items-center align-middle'>
			<Title kind="h1" className='z-20 pb-20'>Huho...</Title>
			<Title kind="h2" className='z-20 pb-10'>Looks like you found an error. No worries, we are reporting errors.</Title>
...
export default function NotFoundPage () {
	return <main className='min-h-screen min-w-full bg-black text-white flex flex-col justify-center items-center gap-4 relative'>
		<div className='z-20 flex flex-col items-center align-middle'>
			<Title kind="h1" className='z-20 pb-20'>Page not found ;(</Title>
			<Title kind="h2" className='z-20 pb-10'>You might have navigated to an unkown or an old page</Title>
			<Link to='/'>Home page</Link>
		</div>
