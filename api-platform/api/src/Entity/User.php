...
{
    #[Groups(['admin:collection', 'post:collection', 'user:read', 'message:channel:read', 'channel:read', 'user:collection', 'user:read:me', 'channel:collection', 'user:read:artist', 'partnership:read', 'studio:read'])]
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    private ?int $id = null;

    #[Groups(['admin:collection', 'post:collection', 'user:read', 'user:forget-password', 'user:collection', 'user:register', 'user:register:read', 'user:login', 'user:patch', 'user:read:me', 'user:patch:me'])]
    #[Assert\NotBlank]
    #[Assert\Email]
    #[ORM\Column(length: 180, unique: true)]
    private ?string $email = null;

    #[Groups(['admin:collection', 'user:patch', 'user:read', 'user:collection', 'user:read:me'])]
    #[ORM\Column]
    ...
    #[Assert\NotBlank]
    #[Groups(['admin:collection', 'post:collection', 'channel:collection', 'channel:read', 'user:read', 'user:read:artist',  'user:register', 'user:register:read', 'user:patch', 'user:collection', 'user:read:me', 'user:patch:me', 'studio:invite:read', 'partnership:read', 'studio:read'])]
    #[Assert\Length(min: 4, max: 32)]
    #[ORM\Column(length: 255, unique: true)]
    private ?string $username = null;

    #[Groups(['admin:collection', 'post:collection', 'channel:collection', 'channel:read', 'user:read', 'user:read:artist', 'user:patch', 'user:collection', 'user:read:me', 'user:patch:me', 'studio:invite:read', 'partnership:read', 'studio:read'])]
    ...
    #[Groups(['admin:collection', 'user:read', 'user:patch'])]
    #[ORM\Column(options: ["default" => false])]
    private ?bool $isBanned = false;

    #[Groups(['admin:collection', 'user:read', 'user:patch', 'user:read:me'])]
    #[ORM\Column(length: 255, nullable: true)]
    private ?string $instagramToken = null;

    #[Groups(['admin:collection', 'user:read', 'user:read:me'])]
    #[ORM\Column]
    ...
    #[Groups(['admin:collection', 'user:patch:me', 'user:read', 'user:patch', 'user:collection', 'user:read:me', 'user:patch:me'])]
    ...
    #[Groups(['admin:collection', 'user:read', 'user:collection', 'user:patch', 'user:read:me'])]
    #[ORM\Column(options: ["default" => false])]
