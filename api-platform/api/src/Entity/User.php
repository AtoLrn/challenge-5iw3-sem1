...
{
    #[Groups(['admin:collection', 'admin:read', 'post:collection', 'user:read', 'message:channel:read', 'channel:read', 'user:collection', 'user:read:me', 'channel:collection', 'user:read:artist', 'partnership:read', 'studio:read', 'bookRequest:me:collection', 'bookRequest:collection', 'feedback:collections'])]
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    private ?int $id = null;
